...
**Osasco, SP** · [kara.gottschall@outlook.com](mailto:kara.gottschall@outlook.com) · (11) 9 6931-6397 · [LinkedIn](https://www.linkedin.com/in/kgottschall) · [GitHub](https://github.com/KaraGottschall)
...
- **RFQs end-to-end:** ASP.NET Core MVC (.NET 10), Dapper e MySQL — criação, análise, cotação, aprovação e acompanhamento.
- **Workflow multi-perfil:** Cookie Authentication, policies/claims e telas por perfil (Controladoria, Requisitante, Suprimentos, Operações).
- **Portal de fornecedores:** acesso público restrito por token exclusivo para cotações, anexos e questionários, com trava pós-envio.
...
- **Backend:** C# (.NET Core/8/10) · ASP.NET Core MVC · APIs REST
- **Frontend:** Vue.js + Razor (híbrido) · TypeScript · CSS/Bootstrap
- **Arquitetura:** Clean Architecture · DDD · SOLID · Repository Pattern · Injeção de Dependência
- **Dados:** Dapper · EF Core · SQL Server · MySQL
- **Cloud & DevOps:** AWS S3 (URLs pré-assinadas) · GitHub Actions · Docker · Postman
- **Domínio:** Service Desk/tickets · sprints/Kanban · dashboards (KPI/heatmap) · RBAC · LGPD
- **Segurança:** CSRF · CSP/nonce · SonarQube/Quality Gates
